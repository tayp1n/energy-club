...
if ( ! class_exists( 'Rx_Theme_Wizard_Settings' ) ) {

	/**
	 * Define Rx_Theme_Wizard_Settings class
	 */
	class Rx_Theme_Wizard_Settings {
		...
		public function get_defaults( $part = null ) {
			...
			if ( null === $this->defaults ) {
				include rx_theme_wizard()->path( 'includes/config/default-config.php' );
...
/**
 * Returns instance of Rx_Theme_Wizard_Settings
 *
 * @return object
 */
function rx_theme_wizard_settings() {
	return Rx_Theme_Wizard_Settings::get_instance();
}
