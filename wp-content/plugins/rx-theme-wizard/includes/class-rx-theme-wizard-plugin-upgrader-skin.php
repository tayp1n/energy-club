...
class Rx_Theme_Wizard_Plugin_Upgrader_Skin extends Plugin_Installer_Skin {
	...
	public function header() {
		...
		echo '<div class="rx-theme-wizard-install-results">';
			echo '<div class="rx-theme-wizard-install-results__trigger">';
				esc_html_e( 'Details', 'rx-theme-wizard' );
			echo '</div>';
			echo '<ul>';
	}
