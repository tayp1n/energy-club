...
if ( ! class_exists( 'Rx_Theme_Assistant_Elementor_Plugin_Ext' ) ) {

	/**
	 * Define Rx_Theme_Assistant_Elementor_Plugin_Ext class
	 */
	class Rx_Theme_Assistant_Elementor_Plugin_Ext {
		...
		public function init() {
			 ...
			 * Nucleo Mini Package
			 */
			if ( filter_var( rx_theme_assistant_settings()->get( 'nucleo-mini-package' ), FILTER_VALIDATE_BOOLEAN ) ) {
		...
		public function get_nc_mini_icons_set() {
			...
			include rx_theme_assistant()->plugin_path( 'assets/fonts/nucleo-outline-icon-font/nucleo-outline.css' );
		...
		public function enqueue_icon_font() {
			wp_enqueue_style(
				'rx-theme-assistant-nucleo-outline',
				rx_theme_assistant()->plugin_url( 'assets/fonts/nucleo-outline-icon-font/nucleo-outline.css' ),
				array(),
				'1.0.0'
			);
		}
...
/**
 * Returns instance of Rx_Theme_Assistant_Elementor_Plugin_Ext
 *
 * @return object
 */
function rx_theme_assistant_elementor_plugin_ext() {
	return Rx_Theme_Assistant_Elementor_Plugin_Ext::get_instance();
}

rx_theme_assistant_elementor_plugin_ext()->init();
