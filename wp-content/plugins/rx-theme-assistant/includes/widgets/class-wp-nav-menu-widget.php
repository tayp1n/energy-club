<?php
/**
 * Widget API: Rx_Nav_Menu_Widget class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
...
if ( ! class_exists( 'Rx_Nav_Menu_Widget' ) ) {

	class Rx_Nav_Menu_Widget extends WP_Widget {
	...
	add_action( 'widgets_init', 'rx_theme_assistant_register_wp_nav_menu_widget' );

	/**
	 * Register elementor template widget.
	 */
	function rx_theme_assistant_register_wp_nav_menu_widget() {
		unregister_widget( 'WP_Nav_Menu_Widget' );
		register_widget( 'Rx_Nav_Menu_Widget' );
	}
}
