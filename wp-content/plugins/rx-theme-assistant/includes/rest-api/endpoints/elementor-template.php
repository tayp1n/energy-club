<?php
namespace Rx_Theme_Assistant\Endpoints;
...
class Elementor_Template extends Base {
	...
	public function callback( $request ) {
		...
		$transient_key = md5( sprintf( 'rx_theme_assistant_elementor_template_data_%s', $template_id ) );
		...
		if ( $fonts_link ) {
			$template_styles[ 'rx-theme-assistant-google-fonts-css-' . $template_id ] = $fonts_link;
		}
	...
	public function get_elementor_template_fonts_url( $template_id ) {
		...
		$post_css = new Core\Files\CSS\Post( $template_id );
