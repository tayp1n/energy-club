...
class Rx_Theme_Assistant_Group_Control_Transform_Style extends Group_Control_Base {
	...
	public static function get_type() {
		return 'rx-theme-assistant-transform-style';
	}
	...
	protected function init_fields() {
		...
		$controls['translate_x'] = [
			'label' => _x( 'Translate X', 'Transform Control', 'rx-theme-assistant' ),
		...
		$controls['translate_y'] = [
			'label' => _x( 'Translate Y', 'Transform Control', 'rx-theme-assistant' ),
			'type' => Controls_Manager::SLIDER,
			'render_type' => 'ui',
			'required' => 'true',
			'responsive' => true,
