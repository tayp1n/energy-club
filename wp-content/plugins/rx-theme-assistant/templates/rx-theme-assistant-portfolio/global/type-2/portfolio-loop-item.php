...
$__processed_item = $this->__processed_item;
$this->__processed_item = false;
$cover_icon = $this->__get_icon( 'cover_icon', '<div class="rx-theme-assistant-portfolio__cover-icon">%s</div>' );
$this->__processed_item = $__processed_item;
	...
	<div class="rx-theme-assistant-portfolio__inner">
		<a <?php echo $this->get_render_attribute_string( $link_instance ); ?>>
			<div class="rx-theme-assistant-portfolio__image">
				...
				<div class="rx-theme-assistant-portfolio__cover"><?php echo $cover_icon; ?></div>
			</div>
		</a>
		<div class="rx-theme-assistant-portfolio__content">
			<div class="rx-theme-assistant-portfolio__content-inner"><?php
				...
				echo $this->__loop_item( array( 'item_title' ), '<' . $title_tag . ' class="rx-theme-assistant-portfolio__title">%s</' . $title_tag . '>' );
				echo $this->__get_item_category();
				echo $this->__loop_item( array( 'item_desc' ), '<p class="rx-theme-assistant-portfolio__desc">%s</p>' );
