...
$attr_array = array();
$class_array = array( 'rx-theme-assistant-instagram-gallery__instance' );
...
$content = sprintf( '<div class="%1$s" %2$s %3$s>%4$s</div>', $classes, $attrs, $data_settings, $this->render_gallery() );

echo $this->maybe_apply_carousel_wrappers( $content, $settings );
